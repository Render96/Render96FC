...
charmap = {
    "0": [0x00, None], "０": [0x00, None], "1": [0x01, None], "１": [0x01, None],
    "2": [0x02, None], "２": [0x02, None], "3": [0x03, None], "３": [0x03, None],
    "4": [0x04, None], "４": [0x04, None], "5": [0x05, None], "５": [0x05, None],
    "6": [0x06, None], "６": [0x06, None], "7": [0x07, None], "７": [0x07, None],
    "8": [0x08, None], "８": [0x08, None], "9": [0x09, None], "９": [0x09, None],
    "A": [0x0A, None], "Ａ": [0x0A, None], "B": [0x0B, None], "Ｂ": [0x0B, None],
    "C": [0x0C, None], "Ｃ": [0x0C, None], "D": [0x0D, None], "Ｄ": [0x0D, None],
    "E": [0x0E, None], "Ｅ": [0x0E, None], "F": [0x0F, None], "Ｆ": [0x0F, None],
    "G": [0x10, None], "Ｇ": [0x10, None], "H": [0x11, None], "Ｈ": [0x11, None],
    "I": [0x12, None], "Ｉ": [0x12, None], "J": [0x13, None], "Ｊ": [0x13, None],
    "K": [0x14, None], "Ｋ": [0x14, None], "L": [0x15, None], "Ｌ": [0x15, None],
    "M": [0x16, None], "Ｍ": [0x16, None], "N": [0x17, None], "Ｎ": [0x17, None],
    "O": [0x18, None], "Ｏ": [0x18, None], "P": [0x19, None], "Ｐ": [0x19, None],
    "Q": [0x1A, None], "Ｑ": [0x1A, None], "R": [0x1B, None], "Ｒ": [0x1B, None],
    "S": [0x1C, None], "Ｓ": [0x1C, None], "T": [0x1D, None], "Ｔ": [0x1D, None],
    "U": [0x1E, None], "Ｕ": [0x1E, None], "V": [0x1F, None], "Ｖ": [0x1F, None],
    "W": [0x20, None], "Ｗ": [0x20, None], "X": [0x21, None], "Ｘ": [0x21, None],
    "Y": [0x22, None], "Ｙ": [0x22, None], "Z": [0x23, None], "Ｚ": [0x23, None],
